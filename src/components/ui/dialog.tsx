...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ...
    style={{ background: 'rgba(15,15,26,0.5)', backdropFilter: 'blur(4px)' }}
    {...props}
  />
));
  ...
  <DialogPortal>
    ...
    >
      ...
      <DialogPrimitive.Close
        className="absolute right-4 top-4 rounded-lg p-1 transition-all duration-150 focus:outline-none disabled:pointer-events-none"
        style={{ color: 'rgba(0,0,0,0.4)' }}
        onMouseEnter={(e) => { (e.currentTarget as HTMLElement).style.background = 'rgba(0,0,0,0.06)'; (e.currentTarget as HTMLElement).style.color = 'rgba(0,0,0,0.8)'; }}
        onMouseLeave={(e) => { (e.currentTarget as HTMLElement).style.background = ''; (e.currentTarget as HTMLElement).style.color = 'rgba(0,0,0,0.4)'; }}
      >
        <X className="h-4 w-4" />
