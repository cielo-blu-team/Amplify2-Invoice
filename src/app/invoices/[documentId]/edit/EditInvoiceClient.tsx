...
export default function EditInvoiceClient({ document: doc, lineItems }: Props) {
  ...
  const handleSubmit = async (data: DocumentFormData) => {
    ...
    try {
      ...
      showSuccess('請求書を更新しました');
      router.push(`/invoices/${doc.documentId}`);
    } finally {
      setLoading(false);
    }
  };
